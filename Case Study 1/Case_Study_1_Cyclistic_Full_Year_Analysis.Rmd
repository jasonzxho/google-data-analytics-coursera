...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = weekday, 
    ...
    theme(text = element_text(family = "encodesans-sc"),
          ...
          plot.background = element_rect(fill = "#fcfcfc"),       # match colour with presentation deck background
          plot.caption = element_text(colour = "grey30",
                                      size = 8, 
                                      hjust = 1),
          plot.title = element_text(margin = margin(b = 15)),
          panel.background = element_rect(fill = "#fcfcfc"),      # match colour with presentation deck background
    ...
    scale_y_continuous(labels = scales::comma, 
                       expand = c(0, 0)) +
    ggsave('data/processed/graphs/dow_rides.png', width = 6.5, height = 4.5, bg = "#fcfcfc")      # match colour with presentation deck background
```
...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = weekday, 
    ...
    scale_y_continuous(labels = scales::comma, 
                       expand = c(0, 0)) +
    ggsave('data/processed/graphs/dow_ride_duration.png', width = 6.5, height = 4.5, bg = "#fcfcfc")      # match colour with presentation deck background
```
...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = weekday, 
    ...
    scale_y_continuous(labels = scales::percent, 
                       expand = c(0, 0)) +
    ggsave('data/processed/graphs/dow_rt_pct.png', width = 6.5, height = 4.5, bg = "#fcfcfc")      # match colour with presentation deck background
```
...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = month, 
    ...
    scale_x_date(breaks = date_breaks("1 month"),
                 expand = c(0,0),
                 date_labels = "%b-%Y") +
    ggsave('data/processed/graphs/monthly_rides.png', width = 6.5, height = 4.5, bg = "#fcfcfc")      # match colour with presentation deck background
```
...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = month, 
    ...
    scale_x_date(breaks = date_breaks("1 month"),
                 expand = c(0,0),
                 date_labels = "%b-%Y") +
    ggsave('data/processed/graphs/monthly_trip_duration.png', width = 6.5, height = 4.5, bg = "#fcfcfc")      # match colour with presentation deck background
```
...
all_trips_v2 %>% 
  ...
  ggplot(aes(x = month, 
    ...
    scale_x_date(breaks = date_breaks("1 month"),
                 expand = c(0,0),
                 date_labels = "%b-%Y") +
    ggsave('data/processed/graphs/monthly_rt_pct.png', width = 6.5, height = 4.5, bg = "#fcfcfc")       # match colour with presentation deck background
```
